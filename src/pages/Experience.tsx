  ...
  return (
    <div>
        <div className="xs:mt-[3rem] md:mt-[10rem] absolute left-[-7rem] xs:w-[10rem] xs:h-[5rem] md:w-[10rem] md:h-[20rem] rounded-[3rem] bg-gradient-to-r from-[#cdccff] to-[#aeadff] -z-10">
            <h3 className="xs:text-[3rem] md:text-[5rem] text-blue-100 font-bold text-end">{index}</h3>
        </div>
        ...
        <BoxReveal  boxColor={"#5046e6"} duration={0.5}>
            <p className="xs:text-[2.5rem] md:text-[3.5rem] font-semibold">
            <span className="text-[#faf9ff]">{title}</span>
            </p>
        </BoxReveal>

        <BoxReveal boxColor={"#5046e6"} duration={0.5}>
            <h2 className="xs:text-[1.2rem] md:text-[1.5rem] mt-[.5rem] text-[1rem]">
            {about}
            </h2>
        </BoxReveal>
        ...
        <BoxReveal boxColor={"#5046e6"} duration={0.5}>
            ...
            <p>
                <br /><br />
                <span className="xs:text-[1.2rem] md:text-[1.5rem] font-bold text-[#ececff]">Applied Tech Stack</span>,
                <br /><br />
                <span className="xs:text-[1rem] md:text-[1.5rem] font-semibold text-[#f4eaff]">{lang}</span>,
                <br />
